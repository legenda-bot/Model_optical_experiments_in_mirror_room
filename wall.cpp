...
Point GetFirstIntersectionOfRayAndWall(const Ray& ray, const Wall& wall) { // apex of the beam is not considered
	if (wall.GetType() == "Arc") {
		std::pair<Point, Point> intersections = GetIntersectionLineAndCircle(ray, wall.GetArc());
